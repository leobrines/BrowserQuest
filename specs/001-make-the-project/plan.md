...
**Input**: Feature specification from `<repository_root>/specs/001-make-the-project/spec.md`
...
**Output**: `<repository_root>/specs/001-make-the-project/research.md`
...
Create `<repository_root>/specs/001-make-the-project/quickstart.md` with step-by-step validation:
...
**Output**: `<repository_root>/specs/001-make-the-project/quickstart.md`
